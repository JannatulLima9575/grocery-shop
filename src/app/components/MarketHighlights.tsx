      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
            ...
            <p className="text-gray-700 dark:text-gray-300 mt-1">Onion +৳10</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
            ...
            <p className="text-gray-700 dark:text-gray-300 mt-1">Tomato −৳8</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
            ...
            <p className="text-gray-700 dark:text-gray-300 mt-1">Potato</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
            ...
            <p className="text-gray-700 dark:text-gray-300 mt-1">Green Chili</p>
          </div>
        </div>
      </div>
    </section>
